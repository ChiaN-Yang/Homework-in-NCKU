...
int main()
{
	...
	insert_node(&search_tree, 1);
	insert_node(&search_tree, 3);
	insert_node(&search_tree, 5);
	insert_node(&search_tree, 7);
	insert_node(&search_tree, 2);
	insert_node(&search_tree, 4);
	search_tree = delete_node(search_tree, 3);
